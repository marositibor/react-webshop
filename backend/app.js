...
db.serialize(function() {
    ...
    db.run(`INSERT INTO product (name,shortSpecs,image,qty,price,specs) VALUES ('Telefon','gyors 8gb rozsaszin','http://localhost:3050/img/telefon',10,999,'{"szélesség":"6 cm","hosszúság":"10 cm","vastagság":"2 cm","kamera megapixel":"10","belső memória mérete":"8 GB","processzor":"A13 Bionic"}')`);
